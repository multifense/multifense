...
namespace C_SharpClient_1._1
{
    class Monster : GameObject
    {
        ...
        public override void SetGameSession(GameSession gameSession)
        {
            ...
            base.Rec = new Rectangle((int)lastPoint.p.X, (int)lastPoint.p.Y, base.Rec.Width, base.Rec.Height);
        }
        ...
        public void move()
        {
            ...
            if (currDistance <= 0)
            {
                ...
                base.Rec = new Rectangle((int)this.lastPoint.p.X, (int)this.lastPoint.p.Y, base.Rec.Width, base.Rec.Height);
        ...
        {
            double distX = distance * Math.Round(this.lastPoint.dir.X);
            double distY = distance * Math.Round(this.lastPoint.dir.Y);
            base.Rec = base.Rec = new Rectangle((int)(base.Rec.X + distX), (int)(base.Rec.Y + distY), base.Rec.Width, base.Rec.Height);
