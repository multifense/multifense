...
namespace C_SharpClient_1._1
{
    class TrackingProjectile : GameObject
    {
        ...
        /// </summary>
        public TrackingProjectile(Monster mo, float towX, float towY, double speed, double damage)
        {
            this.target = mo;
        ...
        public TrackingProjectile(float towX, float towY,double speed, Monster Target, double dmg, Texture2D texture)
        {
            base.type = "Projectile";
            base.Rec = new Rectangle((int)towX, (int)towY, 20, 20);
            this.speed = speed;
